...
const double MAX_SPEED_THRESHOLD = 7;  // max plausible rowing speed in m/s
const double MIN_SPEED_THRESHOLD = 0.8;     // max estimated drift speed for row boat in m/s
